...
@router.post(
    ...
    description=(
        ...
        "Input / Entrada: TaskCreateRequest payload.\n"
        "Output / Saida: TaskReadResponse representation with id and timestamps."
    ),
...
@router.get(
    ...
    description=(
        ...
        "Output / Saida: TaskReadResponse if found, otherwise 404."
    ),
...
@router.put(
    ...
    description=(
        ...
        "Input / Entrada: task_id path parameter and TaskUpdateRequest body.\n"
